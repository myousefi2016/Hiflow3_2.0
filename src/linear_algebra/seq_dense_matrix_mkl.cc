...
namespace hiflow
{
    namespace la
    {
        ...
        template<>
        void SeqDenseMatrix<double>::compute_eigenvalues_and_vectors_mkl ( )
        {
#ifdef WITH_MKL
            ...
            MKL_INT n = static_cast < MKL_INT > ( ncols_ );
        ...
        template<>
        void SeqDenseMatrix<float>::compute_eigenvalues_and_vectors_mkl ( )
        {
#ifdef WITH_MKL
            //prepare working arguments
            MKL_INT info = 0;
        ...
        template<>
        void SeqDenseMatrix<double>::VectorMult_mkl ( const double *invec, double *outvec )
        {
#ifdef WITH_MKL
        ...
        template<>
        void SeqDenseMatrix<float>::VectorMult_mkl ( const float *invec, float *outvec )
        {
#ifdef WITH_MKL
        ...
        template<>
        void SeqDenseMatrix<double>::MatrixMult_mkl ( const SeqDenseMatrix<double> *inMat, SeqDenseMatrix<double> *outMat )
        {
#ifdef WITH_MKL
        ...
        template<>
        void SeqDenseMatrix<float>::MatrixMult_mkl ( const SeqDenseMatrix<float> *inMat, SeqDenseMatrix<float> *outMat )
        {
#ifdef WITH_MKL
        ...
        template<>
        void SeqDenseMatrix<double>::Factorize_mkl ( )
        {
#ifdef WITH_MKL
            MKL_INT n = static_cast < MKL_INT > ( nrows_ );

            MKL_INT *perm = new MKL_INT[nrows_];
        ...
        template<>
        void SeqDenseMatrix<float>::Factorize_mkl ( )
        {
#ifdef WITH_MKL
            MKL_INT n = static_cast < MKL_INT > ( nrows_ );
        ...
        template<>
        void SeqDenseMatrix<double>::QRFactorize_mkl ( SeqDenseMatrix<double> &Q, SeqDenseMatrix<double> &R )
        {
#ifdef WITH_MKL
            // copy this to Q
            for ( int i = 0; i < nrows_; ++i )
        ...
        template<>
        void SeqDenseMatrix<float>::QRFactorize_mkl ( SeqDenseMatrix<float> &Q, SeqDenseMatrix<float> &R )
        {
#ifdef WITH_MKL
            // copy this to Q
            for ( int i = 0; i < nrows_; ++i )
        ...
        template<>
        void SeqDenseMatrix<double>::HessenbergReduction_mkl ( SeqDenseMatrix<double> &H, SeqDenseMatrix<double> &V )
        {
#ifdef WITH_MKL
            ...
            if ( info < 0 )
            {
                LOG_ERROR ( "Argument " << -info << " of dorghr has an illegal value!" );
                exit ( -1 );
            }
        ...
        template<>
        void SeqDenseMatrix<float>::HessenbergReduction_mkl ( SeqDenseMatrix<float> &H, SeqDenseMatrix<float> &V )
        {
#ifdef WITH_MKL
            ...
            if ( info < 0 )
            {
                LOG_ERROR ( "Argument " << -info << " of sgehrd has an illegal value!" );
                exit ( -1 );
            }
            ...
            if ( info < 0 )
            {
                LOG_ERROR ( "Argument " << -info << " of sorghr has an illegal value!" );
                exit ( -1 );
            }
        ...
        template<>
        void SeqDenseMatrix<double>::ForwardBackward_mkl ( double *x )
        {
#ifdef WITH_MKL
            //setup parameters
            MKL_INT info = 0;
            ...
            for ( int i = 0; i < nrows_; ++i )
            {
                perm[i] = static_cast < MKL_INT > ( permutation_[i] );
            }
        ...
        template<>
        void SeqDenseMatrix<float>::ForwardBackward_mkl ( float *x )
        {
#ifdef WITH_MKL
            //setup parameters
            MKL_INT info = 0;
