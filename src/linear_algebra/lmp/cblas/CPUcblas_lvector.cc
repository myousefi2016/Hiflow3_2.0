...
#    define ERROR LOG_ERROR("no Cblas support");  exit(-1);
...
CPUcblas_lVector<ValueType>::CPUcblas_lVector ( const int size, const std::string name )
{
#ifdef WITH_CBLAS
    this->Init ( size, name );
...
template <>
int CPUcblas_lVector<double>::ArgMin ( void ) const
{
#ifdef WITH_CBLAS
    int minimum = -1;
...
template <>
int CPUcblas_lVector<float>::ArgMin ( void ) const
{
#ifdef WITH_CBLAS
    int minimum = -1;
...
template <>
int CPUcblas_lVector<double>::ArgMax ( void ) const
{
#ifdef WITH_CBLAS
    int maximum = -1;
...
template <>
int CPUcblas_lVector<float>::ArgMax ( void ) const
{
#ifdef WITH_CBLAS
    int maximum = -1;
...
template <>
double CPUcblas_lVector<double>::Norm1 ( void ) const
{
#ifdef WITH_CBLAS
    double nrm1 = -1;
...
template <>
float CPUcblas_lVector<float>::Norm1 ( void ) const
{
#ifdef WITH_CBLAS
    float nrm1 = -1;
...
template <>
double CPUcblas_lVector<double>::Norm2 ( void ) const
{
#ifdef WITH_CBLAS
    double nrm2 = -1;
...
template <>
float CPUcblas_lVector<float>::Norm2 ( void ) const
{
#ifdef WITH_CBLAS
    float nrm2 = -1;
...
template <typename ValueType>
ValueType CPUcblas_lVector<ValueType>::Dot ( const lVector<ValueType> &vec ) const
{
    ValueType dot = 0.0;
...
template <typename ValueType>
void CPUcblas_lVector<ValueType>::Axpy ( const lVector<ValueType> &vec, const ValueType scalar )
{
    if ( const CPU_lVector<ValueType> *casted_vec =
         dynamic_cast < const CPU_lVector<ValueType>* > ( &vec ) )
    {
...
template <>
void CPUcblas_lVector<double>::Axpy ( const CPU_lVector<double> &vec, const double scalar )
{
#ifdef WITH_CBLAS
...
template <>
void CPUcblas_lVector<float>::Axpy ( const CPU_lVector<float> &vec, const float scalar )
{
#ifdef WITH_CBLAS
...
template <typename ValueType>
void CPUcblas_lVector<ValueType>::ScaleAdd ( const ValueType scalar, const lVector<ValueType> &vec )
{
...
template <>
void CPUcblas_lVector<double>::ScaleAdd ( const double scalar, const CPU_lVector<double> &vec )
{
#ifdef WITH_CBLAS
...
template <>
void CPUcblas_lVector<float>::ScaleAdd ( const float scalar, const CPU_lVector<float> &vec )
{
#ifdef WITH_CBLAS
...
template <>
void CPUcblas_lVector<double>::Scale ( const double scalar )
{
#ifdef WITH_CBLAS
...
template <>
void CPUcblas_lVector<float>::Scale ( const float scalar )
{
#ifdef WITH_CBLAS
...
template <typename ValueType>
void CPUcblas_lVector<ValueType>::Rot ( lVector<ValueType> *vec, const ValueType &sc, const ValueType &ss )
{
...
template <>
void CPUcblas_lVector<double>::Rot ( CPU_lVector<double> *vec, const double &sc, const double &ss )
{
#ifdef WITH_CBLAS
...
template <>
void CPUcblas_lVector<float>::Rot ( CPU_lVector<float> *vec, const float &sc, const float &ss )
{
#ifdef WITH_CBLAS
...
template <>
void CPUcblas_lVector<double>::Rotg ( double *sa, double *sb, double *sc, double *ss ) const
{
#ifdef WITH_CBLAS
...
template <>
void CPUcblas_lVector<float>::Rotg ( float *sa, float *sb, float *sc, float *ss ) const
{
#ifdef WITH_CBLAS
...
template <typename ValueType>
void CPUcblas_lVector<ValueType>::Rotm ( lVector<ValueType> *vec, const ValueType &sparam )
{
...
template <>
void CPUcblas_lVector<double>::Rotm ( CPU_lVector<double> *vec, const double &sparam )
{
#ifdef WITH_CBLAS
...
template <>
void CPUcblas_lVector<float>::Rotm ( CPU_lVector<float> *vec, const float &sparam )
{
#ifdef WITH_CBLAS
...
template <>
void CPUcblas_lVector<double>::Rotmg ( double *sd1, double *sd2, double *x1, const double &x2, double *sparam ) const
{
#ifdef WITH_CBLAS
...
template <>
void CPUcblas_lVector<float>::Rotmg ( float *sd1, float *sd2, float *x1, const float &x2, float *sparam ) const
{
#ifdef WITH_CBLAS
