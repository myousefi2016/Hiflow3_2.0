...
#ifndef HIFLOW_QUADRATURE_QUADRATUREECONOMICALGAUSSHEXAHEDRON_H
#    define HIFLOW_QUADRATURE_QUADRATUREECONOMICALGAUSSHEXAHEDRON_H
...
namespace hiflow
{
    ...
    class QuadratureEconomicalGaussHexahedron : public QuadratureType<DataType>
    {
      public:
        QuadratureEconomicalGaussHexahedron ( );
        QuadratureEconomicalGaussHexahedron<DataType>* clone ( ) const;
