...
#ifndef HIFLOW_QUADRATURE_QUADRATUREECONOMICALGAUSSQUADRILATERAL_H
#    define HIFLOW_QUADRATURE_QUADRATUREECONOMICALGAUSSQUADRILATERAL_H
...
namespace hiflow
{
    ...
    class QuadratureEconomicalGaussQuadrilateral : public QuadratureType<DataType>
    {
      public:
        QuadratureEconomicalGaussQuadrilateral ( );
        QuadratureEconomicalGaussQuadrilateral<DataType>* clone ( ) const;
