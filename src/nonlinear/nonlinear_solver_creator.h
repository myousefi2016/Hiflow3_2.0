...
namespace hiflow
{
    ...
    class NonlinearSolverCreator
    {
      public:
        ...
        virtual NonlinearSolver<LAD>* params ( VectorType* residual, MatrixType* matrix, const PropertyTree& c ) = 0;
        virtual NonlinearSolver<LAD>* params ( const PropertyTree& c ) = 0;
    };
