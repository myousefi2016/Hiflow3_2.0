...
namespace hiflow
{
    namespace doffem
    {
        ...
        /// \brief Linear transformation mapping from reference to physical cell for a Triangle
        /// \author Michael Schick<br>Martin Baumann
        ///

        template<class DataType>
        class LinearTriangleTransformation : public CellTransformation<DataType>
        {
          public:

            typedef std::vector<DataType> Coord;

            explicit LinearTriangleTransformation ( int gdim );
