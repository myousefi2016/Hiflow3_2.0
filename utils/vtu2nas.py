...
if len(sys.argv) != 3:
  print 'Usage: vtu2inp.py <src_file.???> <dest_file.vtu>'
  sys.exit(1)
...
if (src_postfix == "" or (src_postfix != "vtu" and src_postfix != "vtu")):
...
if (dest_postfix == "" or (dest_postfix != "inp")):
