...
#ifndef MASS_MATRIX_CYL_ASSEMBLER_H
#    define MASS_MATRIX_CYL_ASSEMBLER_H
...
class MassMatrixCylAssembler : public MassMatrixAssembler<DIM, VARDIM, DataType>
{
  public:

    MassMatrixCylAssembler ( )
    {
    }
