...
#ifndef MET_FLOW_CONVDIFF_CYL_ASSEMBLER_H
#    define MET_FLOW_CONVDIFF_CYL_ASSEMBLER_H

///
/// \brief Assembler base class for scalar convection-diffusion-reaction equations in cylindrical coordinates
///
...
class MetFlowConvDiffCylAssembler : public MetFlowConvDiffAssembler<DIM, DataType>
{
  public:

    MetFlowConvDiffCylAssembler ( );
    ...
    virtual void operator() ( const Element<DataType>& element, const Quadrature<DataType>& quadrature, LocalMatrix& lm )
    {
        ...
        MetFlowConvDiffCylAssembler<DIM, DataType>::assemble_local_matrix ( element, lm );
    }
    ...
    {
        MetFlowConvDiffAssembler<DIM, DataType>::initialize_for_element ( element, quadrature );
        MetFlowConvDiffCylAssembler<DIM, DataType>::assemble_local_vector ( element, lv );
    }
    ...
    {
        MetFlowConvDiffAssembler<DIM, DataType>::initialize_for_element ( element, quadrature );
        MetFlowConvDiffCylAssembler<DIM, DataType>::assemble_local_scalar ( element, ls );
    }
