...
#ifndef MET_FLOW_BOUS_EST_ASSEMBLER_H
#    define MET_FLOW_BOUS_EST_ASSEMBLER_H
...
class MetFlowBousEstimatorAssembler : public virtual MetFlowIncompEstimatorAssembler<DIM, DataType>, public virtual MetFlowBousAssembler<DIM, DataType>
{
    typedef typename DGGlobalAssembler<DataType>::InterfaceSide InterfaceSide;

  public:

    MetFlowBousEstimatorAssembler ( );
