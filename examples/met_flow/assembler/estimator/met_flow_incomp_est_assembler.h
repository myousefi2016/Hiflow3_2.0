...
#ifndef MET_FLOW_INCOMP_EST_ASSEMBLER_H
#    define MET_FLOW_INCOMP_EST_ASSEMBLER_H
...
class MetFlowIncompEstimatorAssembler : public virtual MetFlowEstimatorAssembler<DIM, DataType>, public virtual MetFlowIncompAssembler<DIM, DataType>
{
    typedef typename DGGlobalAssembler<DataType>::InterfaceSide InterfaceSide;

  public:

    MetFlowIncompEstimatorAssembler ( );
