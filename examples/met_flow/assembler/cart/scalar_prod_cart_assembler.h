...
#ifndef SCALAR_PROD_CART_ASSEMBLERS_H
#    define SCALAR_PROD_CART_ASSEMBLERS_H
...
class ScalarProdCartAssembler : public ScalarProdAssembler<DIM, VARDIM, DataType>
{
  public:
    ScalarProdCartAssembler ( );
