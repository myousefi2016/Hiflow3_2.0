...
#ifndef MET_FLOW_CONVDIFF_CART_ASSEMBLER_H
#    define MET_FLOW_CONVDIFF_CART_ASSEMBLER_H

///
/// \brief Assembler base class for scalar convection-diffusion-reaction equations in cartesian coordinates
///
...
class MetFlowConvDiffCartAssembler : public MetFlowConvDiffAssembler<DIM, DataType>
{
  public:

    MetFlowConvDiffCartAssembler ( );
    ...
    virtual void operator() ( const Element<DataType>& element, const Quadrature<DataType>& quadrature, LocalMatrix& lm )
    {
        ...
        MetFlowConvDiffCartAssembler<DIM, DataType>::assemble_local_matrix ( element, lm );
    }
    ...
    {
        MetFlowConvDiffAssembler<DIM, DataType>::initialize_for_element ( element, quadrature );
        MetFlowConvDiffCartAssembler<DIM, DataType>::assemble_local_vector ( element, lv );
    }
    ...
    {
        MetFlowConvDiffAssembler<DIM, DataType>::initialize_for_element ( element, quadrature );
        MetFlowConvDiffCartAssembler<DIM, DataType>::assemble_local_scalar ( element, ls );
    }
