...
int main ( int argc, char** argv )
{
    ...
    // Read parameters
    std::string fName;
    fName = std::string ( DATADIR ) + "../../examples/convection_diffusion/convdiff.xml";
...
{
    StandardGlobalAssembler<double> global_asm;
    global_asm.assemble_matrix ( space_, *local_asm_, matrix_ );
    global_asm.assemble_vector ( space_, *local_asm_, rhs_ );
